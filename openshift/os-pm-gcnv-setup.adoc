...
* Helm チャートを使用して、OSD クラスタに Trident をインストールします。Helm Chart のインストール方法については、link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy-helm.html["ここをクリックしてください。"]を参照してください。
