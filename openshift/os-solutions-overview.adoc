...
**NetApp Trident Protect**は、NetApp Tridentの無料アドオンとして利用でき、NetApp ONTAPストレージシステムでサポートされるステートフルKubernetesアプリケーションの機能性と可用性を強化する高度なアプリケーションデータ管理機能を提供します。Trident Protectは、パブリッククラウドとオンプレミス環境の両方でコンテナ化されたワークロードの管理、保護、移動を簡素化します。また、APIとCLIを通じて強力な自動化機能も提供します。
