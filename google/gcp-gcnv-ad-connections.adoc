...
NFS KerberosのAES暗号化を有効にするには、 https://docs.cloud.google.com/netapp/volumes/docs/plan-and-prepare/security-considerations["Google Cloud NetApp Volumesのドキュメントをご覧ください"^]。
