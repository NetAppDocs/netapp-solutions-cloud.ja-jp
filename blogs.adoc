...
* link:https://www.netapp.com/blog/aws-fsxo-blg-configure-hybrid-cloud-with-fsx-for-netapp-ontap-and-vmware-cloud-on-aws-sddc-using-vmware-hcx/["VMware HCX を使用して FSx ONTAPと VMware Cloud on AWS SDDC でハイブリッド クラウドを構成する"]
...
* link:https://www.netapp.com/blog/vmware-migrate-workloads-azure/["VMware ワークロードを Azure VMware Solution へ移行しますか？まずこちらをお読みください。"]
